import { Alert, StatusBar, StyleSheet, Text, TouchableOpacity, View, FlatList, Button, Image, Linking } from 'react-native';
...
const MainTasks = ({ navigation = null }: MainTasksProps) => {
  ...
  const [aboutFlag, setAboutFlagVisible] = useState(false);
  ...
  const toggleAboutModal = () => {
    setAboutFlagVisible(true);
  }

  const exitAboutModal = () => {
    setAboutFlagVisible(false);
  }  
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Icon name='information-circle' size={25} color={'white'} style={{margin:5}} onPress={toggleAboutModal}/>
      </View>
      ...
      <Modal isVisible={aboutFlag} onBackdropPress={exitAboutModal}>
        <View style={styles.modalContainer}>

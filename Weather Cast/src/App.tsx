import { ActivityIndicator, ImageBackground, Linking, ScrollView, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, useColorScheme, View} from 'react-native';
...
const WeatherService = () => {
  ...
  const bgImage = () => {
    switch (weatherText) {
      ...
      case 'Smoke':
        return require('../assets/backgrounds/smoke.jpg');
      default:
